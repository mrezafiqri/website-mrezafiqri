...
window.addEventListener('scroll', () => {
    ...
    if (prevScrollpos < currentScrollPos) {
        document.querySelector('#navbar').style.boxShadow = '0px 2px 5px 0px rgba(0,0,0,0.3)';
    } else if (prevScrollpos == 0) {
        document.querySelector('#navbar').style.boxShadow = '0px 0px 0px 0px rgba(0,0,0,0.3)';
    }
...
// Contact
const scriptURL = 'https://script.google.com/macros/s/AKfycbx5fbrhM_0Whh7NDb1mz1kCBIV-DYVhRnKe3mJsKN61BovAirDL3ZS21OrzAf6wqbkcaw/exec'
